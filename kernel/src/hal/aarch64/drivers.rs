use crate::drivers::intr::{InterruptController, aplic, gicv2, plic};
...
impl IntcDriver {
    pub fn map_mmio(&self, kpt: &mut PageTable) {
        match self {
            ...
            IntcDriver::GicV2(intc) => intc.map_mmio(kpt),
        }
    }
    ...
    pub fn set_priority(&self, irq: usize, priority: usize) {
        match self {
            ...
            IntcDriver::GicV2(intc) => intc.set_priority(irq, priority),
        }
    }
    ...
    pub fn set_enable(&self, hartid: usize, irq: usize, enable: bool) {
        match self {
            ...
            IntcDriver::GicV2(intc) => intc.set_enable(hartid, irq, enable),
        }
    }
    ...
    pub fn set_threshold(&self, hartid: usize, threshold: usize) {
        match self {
            ...
            IntcDriver::GicV2(intc) => intc.set_threshold(hartid, threshold),
        }
    }
    ...
    pub fn claim(&self, hartid: usize) -> usize {
        match self {
            ...
            IntcDriver::GicV2(intc) => intc.claim(hartid),
        }
    }
    ...
    pub fn complete(&self, hartid: usize, irq: usize) {
        match self {
            ...
            IntcDriver::GicV2(intc) => intc.complete(hartid, irq),
        }
    }
}
