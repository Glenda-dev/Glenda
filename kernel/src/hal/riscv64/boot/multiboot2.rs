...
pub fn parse(magic: usize, addr: usize) -> MultibootInfo {
    ...
    log!("boot: Multiboot2 detected at {:#x}", addr);
    ...
    while current_addr < end_addr {
        ...
        match tag.typ {
            1 => {
                ...
                log!("boot: Multiboot2 command line: {}", s);
            }
            2 => {
                // Boot loader name
                let s = unsafe {
                ...
                log!("boot: Multiboot2 boot loader: {}", s);
            }
            3 => {
                // Module (initrd)
            ...
            6 => {
                ...
                log!("boot: Multiboot2 memory map ({} entries):", entry_count);
