...
pub fn set_enable(hartid: usize, id: usize, enable: bool) {
    unsafe {
...
pub fn get_enable(hartid: usize, id: usize) -> bool {
    unsafe {
        let context = ctx_index(hartid);
...
pub fn set_threshold(hartid: usize, threshold: usize) {
    unsafe {
...
pub fn get_threshold(hartid: usize) -> usize {
    unsafe {
        let context = ctx_index(hartid);
        let addr = plic_base() + 0x200000 + context * 0x1000;
        read_volatile(addr as *const u32) as usize
...
pub fn set_claim(hartid: usize, id: usize) {
    unsafe {
...
pub fn get_claim(hartid: usize) -> usize {
    unsafe {
